...
describe("Footer Tests", () => {
  ...
  test("should navigate to '/' when 'Home' link is clicked", () => {
    ...
    userEvent.click(screen.getByTestId("footer-home"));
  ...
  test("should navigate to '/inventory' when 'Inventory' link is clicked", () => {
    ...
    userEvent.click(screen.getByTestId("footer-inventory"));
    expect(screen.getByTestId("footer-inventory")).toHaveAttribute(
      "href",
      "/inventory"
    );
  });
  ...
  test("should navigate to '/about' when 'About' link is clicked", () => {
    ...
    userEvent.click(screen.getByTestId("footer-about"));
    expect(screen.getByTestId("footer-about")).toHaveAttribute(
      "href",
      "/about"
    );
  });
  ...
  test("'Inventory' link should have 'footer-current' class when page context is 1", () => {
    ...
    expect(screen.getByTestId("footer-inventory")).toHaveClass(
      "footer-current"
    );
  });
